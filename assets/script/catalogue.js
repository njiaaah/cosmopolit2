...
if(document.querySelector('#mortgageSlider1')) {
    initializeSlider({ minValue: 20, maxValue: 150, minStartingValue: 20, maxStartingValue: 150, stepValue: 1 }, 'mortgageSlider1', 'mortgageMin-value1', 'mortgageMax-value1');
    initializeSlider({ minValue: 2, maxValue: 36, minStartingValue: 2, maxStartingValue: 36, stepValue: 1 }, 'mortgageSlider2', 'mortgageMin-value2', 'mortgageMax-value2');
    initializeSlider({ minValue: 5, maxValue: 50, minStartingValue: 5, maxStartingValue: 50, stepValue: 1 }, 'mortgageSlider3', 'mortgageMin-value3', 'mortgageMax-value3');
}
